...
if __name__ == "__main__":
    ...
    knee_baseline = TrainingPipeline(f"KneeBaseline_{knee_config.encoder_backbone}", knee_config)
    knee_baseline.run()
    knee_baseline.save()
    ...
    hip_baseline = TrainingPipeline(f"HipBaseline_{hip_config.encoder_backbone}", hip_config)
    hip_baseline.run()
    hip_baseline.save()
